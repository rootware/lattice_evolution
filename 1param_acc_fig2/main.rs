...
fn main() {
   let shakingfunctions2p2e: Vec<f64>= vec![3.92699082, 3.92699082, 3.40339204, 0., 3.66519143, 0., 3.14159265, 3.66519143, 3.92699082, 3.92699082,
   ...
   1.04719755, 1.04719755, 0.78539816, 0.78539816]; 
