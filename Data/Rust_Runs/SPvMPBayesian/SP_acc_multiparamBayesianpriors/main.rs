...
fn main() {
   ...
   let latt_shaking : Vec<f64> = vec![3.92699082, 3.92699082, 3.40339204, 0., 3.66519143, 0., 3.14159265, 3.66519143, 3.92699082, 3.92699082,
   ...
   // Create file
   let _file2 = File::create("./SP_acc_multiparamBayesianpriors/test.txt").unwrap();

   // Open file
   let file = OpenOptions::new()
      .write(true)
      .append(true)
      .open("./SP_acc_multiparamBayesianpriors/test.txt").unwrap();
