...
fn main() {
   ...
   let latt_shaking : Vec<f64> =  sp_shaking; /*
In ideal Rust, you could handle this via enums
Note, new code has this as let latt_shaking = shaking_sequences :: shaking :: SP_SHAKING.to_vec();
*/
